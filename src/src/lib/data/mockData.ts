// lib/data/mockData.ts - Real database data from dump.sql

import type { Event, Venue, Brand, City, VenueType } from '../types/api.js';

export const brandData: Brand[] = [
  { brandid: 1, brandpic1: '1.a8f8da513bd221bd9658bf1ef9232e4c7a04d05e.png', brandpic2: '1.2.fd6fa287c69440aac65df5a5850388265751e4e2.jpg', brandname: 'Hanuman', brandfeatured: 0 },
  ...
  { brandid: 6, brandpic1: '6.2b21e9e3ebb62b2e4d2ac1b921fa156bf9ec7477.jpg', brandpic2: '6.2.57ff52f55f5616b8c85ff07562fe02083a41724f.jpg', brandname: 'ABC', brandfeatured: 0 },
...
export const venueData: Venue[] = [
  ...
  { venueid: 2, cityid: 1, venuetype: 'club', venuepic1: '2.08959c0dcb0e800d56b0ac0f4790ba23100d580e.jpg', venuepic2: '2.2.813fd9de357f982aac47d70d433e41de89bbef58.jpg', venuelink: 'https://maps.app.goo.gl/5JghaKX9rKC26yZB6', venuename: 'Pontoon', venuefeatured: 0 },
  ...
  { venueid: 4, cityid: 2, venuetype: 'bar', venuepic1: '4.98775890122211d224d5402af755e76b98c672f5.jpg', venuepic2: '4.2.d91be1892f8701f782fa559214c27fc8c379d197.jpg', venuelink: 'https://maps.app.goo.gl/cFdUjvU3jTXUuQ3m6', venuename: 'Temple Container Pub', venuefeatured: 0 },
  ...
  { venueid: 7, cityid: 1, venuetype: 'bar', venuepic1: '7.927d193728b96c052973f4d991661b2cef7cb90a.jpg', venuepic2: '7.2.476b243ea2d588fb3810342b34cdba9f67ca29ad.jpg', venuelink: 'https://maps.app.goo.gl/jmwGcE6Dk5P9q8R1A', venuename: 'Old Place Pub', venuefeatured: 0 },
  { venueid: 8, cityid: 1, venuetype: 'bar', venuepic1: '8.8a82a27c63f1c572d2320ce4a72e81c4fdd85636.jpg', venuepic2: '8.2.9238f9778c0dddf679a7592ac3afdbd19cc58c66.jpg', venuelink: 'https://maps.app.goo.gl/4d3wQ9ykfM6WV5QK6', venuename: 'KunLun Pub', venuefeatured: 0 },
...
export const events: Event[] = [
  { eventid: 1, brandid: '^5^', venueid: 7, eventpic: '1.80d3a2115ff893d3b6c8ec596391b1f3b9e22037.jpg', eventschema: '12+2', eventschemaprice: 10.20, eventdate: '2025-08-20', eventfeatured: 0, eventtitle: 'Cambodia Lite Session', eventartist: 'Sok Pisey', eventdesc: '' },
  { eventid: 2, brandid: '^2^,^5^', venueid: 6, eventpic: '2.b5cbb741f12352c6500b5c5586bb33e61ee63f92.jpg', eventschema: '', eventschemaprice: 0.00, eventdate: '2025-08-23', eventfeatured: 1, eventtitle: 'Cambodia Lite Session', eventartist: 'Ann Kun Kola', eventdesc: '' },
  { eventid: 3, brandid: '^5^', venueid: 3, eventpic: '3.995339ad45592674b87abf91d19a92a5e01515aa.jpg', eventschema: '', eventschemaprice: 0.00, eventdate: '2025-08-23', eventfeatured: 0, eventtitle: 'Cambodia Lite Session', eventartist: 'Thol Sophiti', eventdesc: '' },
  ...
  { eventid: 5, brandid: '^6^', venueid: 9, eventpic: '5.ac6857bf04f7b36abaa999b4169deae5882a9e8c.jpg', eventschema: '8+2', eventschemaprice: 9.00, eventdate: '2025-08-25', eventfeatured: 0, eventtitle: 'ABC Smooth', eventartist: 'Tep Piseth', eventdesc: '' },
  ...
  { eventid: 8, brandid: '^8^', venueid: 9, eventpic: '8.1b7c43ab87deb53a517ff2b864a9b2bad27d00b3.jpg', eventschema: '12+2', eventschemaprice: 11.60, eventdate: '2025-08-30', eventfeatured: 0, eventtitle: "It's Tiger Time", eventartist: 'Chhay Virakyuth', eventdesc: '' }
];